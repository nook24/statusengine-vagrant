...
echo "Open your browser and navigate to http://$ip/statusengine to visit Statusengine Interface"
echo "If the ip is not working you can use http://localhost:8080/statusengine"
echo "--------------------------"
